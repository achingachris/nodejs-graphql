                ...
                <div class="card-body">
                  <div class="row g-2 align-items-center">
                    <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
                      <a href="{{ route('client-landing') }}" class="btn btn-primary w-100">
                        Client
                      </a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
                      <a href="{{ route('transporter-landing') }}" class="btn btn-secondary w-100">
                        Transporter
                      </a>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
                      <a href="{{ route('admin-landing') }}" class="btn btn-success w-100">
                        Admin
                      </a>
                    </div>
                  </div>
