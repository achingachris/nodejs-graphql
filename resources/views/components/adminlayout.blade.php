...
<body>
        ...
        <div class="nav-item dropdown">
          <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
            ...
            <div class="d-none d-xl-block ps-2">
              <div>John Doe</div>
              <div class="small text-muted mt-1">System Admin</div>
            </div>
          </a>
        ...
        <div class="container-xl">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('admin-vehicles') }}">
                  All Vehicles
                </a>
                <a class="dropdown-item" href="{{ route('admin-add-vehicle') }}">
                  Add a Vehicle
                </a>
              </div>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('admin-routes') }}">
                  All Routes
                </a>
                <a class="dropdown-item" href="{{ route('admin-add-route') }}">
                  Add Routes
                </a>
              </div>
            </li>

            {{-- Value As A Service: Products --}}
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#navbar-help" data-bs-toggle="dropdown"
                data-bs-auto-close="outside" role="button" aria-expanded="false">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
  ...
  {{ $slot }}
  <!-- Libs JS -->
  <script src="{{ asset('theme/libs/apexcharts/dist/apexcharts.min.js?1668287865') }}" defer></script>
  <script src="{{ asset('theme/libs/jsvectormap/dist/js/jsvectormap.min.js?1668287865') }}" defer></script>
  <script src="{{ asset('theme/libs/jsvectormap/dist/maps/world.js?1668287865') }}" defer></script>
  <script src="{{ asset('theme/libs/jsvectormap/dist/maps/world-merc.js?1668287865') }}" defer></script>
  <!-- Tabler Core -->
